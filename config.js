    ...
    "quest": {
        "fishing": {
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                ...
                "1000000026652", "1000000021632", "1000000027759",
        ...
        "foraging": {
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                ...
                "1000000011738", "221872", "183774", "1000000058203", "1000000055808",
                ...
                "1000000058992", "1000000060864", "1000000060323", "1000000052155", "1000000062345"
            ],
        ...
        "statQuests": [
            {
                ...
                "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                     ...
                     "276709", "1000000017472", "1000000041503", "1000000041547", "1000000043706",
                     ...
                     "1000000058157", "1000000058765", "1000000059688", "75818"
                ],
            ...
            },
            {
                ...
                "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                    "273716", "1000000017580", "1000000042880", "1000000058161", "1000000058211", "1000000059559"
                ],
