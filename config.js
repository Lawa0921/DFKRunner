...
const config = {
  ...
  "klay": {
    "quest": {
      "fishing": {
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          ...
          "1000000026652", "1000000021632", "1000000054083",
      ...
      "foraging": {
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          ...
          "301174", "1000000017108", "1000000054071", "1000000100455",
      ...
      "goldMining": {
        ...
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          "1000000089287", "1000000091078", "1000000097425", "1000000061159", "303804", "208697",
          "1000000028133", "1000000037174", "1000000068248", "1000000052561", "1000000091832", "1000000092705",
          "1000000058211", "1000000059559", "1000000074522", "1000000088397", "1000000091334", "1000000012231"
        ],
        "minStamina": 25, // 執行任務的最低體力值
        ...
        "quests": [
          {
            ...
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              ...
              "1000000021351", "248925", "1000000048607",
              ...
              "1000000058157", "1000000062264", "1000000087038",
          ...
          },
          {
            "name": "StatQuest_Dex", // 有地方會用到這個值，不要更改它
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              "1000000092583", "1000000021885", "1000000018216", "1000000041938",
          ...
          },
          {
            "name": "StatQuest_Vit", // 有地方會用到這個值，不要更改它
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              "1000000026987", "1000000028544", "1000000031894", "1000000032435", "1000000053360", "1000000059047",
              "1000000079362", "185295", "181573"
            ],
    ...
    "heroForSale": [ // 你想要販售的英雄與價格，price 請填整數，否則會出錯
      ...
      { "id": "1000000031894", "price": 69 },
      { "id": "1000000038262", "price": 85 },
      { "id": "1000000047143", "price": 79 },
      { "id": "1000000030913", "price": 75 },
      { "id": "1000000036806", "price": 45 },
      { "id": "1000000064160", "price": 59 },
      { "id": "287682", "price": 75 },
      { "id": "181573", "price": 75 },
      { "id": "1000000092703", "price": 35 },
      { "id": "1000000088397", "price": 65 },
      { "id": "2000000001367", "price": 65 },
      { "id": "1000000043525", "price": 65 },
      { "id": "1000000087945", "price": 65 }
    ],
    "useRpcIndex": 0, // 表示你想要使用的 rpc ，0 是 下方 rpcs 的第一個，1 是第二個以次類推，網路卡頓的時候可以嘗試換個 rpc
    "rpcs": [
