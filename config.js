...
const config = {
  ...
  "defikingdoms": {
    "quest": {
        "fishing": {
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                ...
                "1000000059053", "1000000060309", "1000000058992"
            ],
        ...
        "foraging": {
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                ...
                "194654", "259528", "262265", "302481", "1000000029193", "1000000039785",
                "245919", "1000000017180", "303103", "1000000025002", "1000000042867",
                "264398", "266919", "268896", "278579", "300295", "304598",
                ...
                "193857", "1000000020648", "103823", "1000000030678", "305839",
                ...
                "1000000060864", "1000000060323", "1000000052155", "1000000062345"
            ],
        ...
        "goldMining": {
            ...
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                ...
                "273242", "267606", "280117", "302782", "1000000033947", "1000000050447",
        ...
        "gardening": {
            "pairAddressMappings": [
                ...
                },
                {
                    ...
                    "singleBatchAmount": 2, // 單次送出的英雄數量
                    "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                        "1000000014478", "258253", "269798", "277280", "1000000057512"
                    ],
                },                 {
        ...
        "statQuests": [
            {
                ...
                "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                     ...
                     "1000000058157", "1000000058765", "1000000059688", "75818", "1000000062264"
                ],
            ...
            },
            {
                ...
                "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                    "1000000025735", "1000000038262", "1000000043531", "1000000047704", "1000000063769",
            ...
            },
            {
                ...
                "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                    "275725", "1000000022549", "1000000027870", "1000000030734",
    ...
    "heroForSale": [ // 你想要販售的英雄與價格，price 請填整數，否則會出錯
        ...
        { "id": "275285", "price": 55 },
        { "id": "131880", "price": 199 },
        { "id": "1000000029193", "price": 49 },
        { "id": "124147", "price": 55 },
        { "id": "273242", "price": 69 },
        { "id": "1000000051379", "price": 45 },
    ...
    "maxGasPrice": 7000000000, // 表示你可以接受的最大 baseFee 是多少，當 baseFee 超過這個值時任務腳本就會暫停，6000000000 表示 6 Gwei，請依你的需要調整
