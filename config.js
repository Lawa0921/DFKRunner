...
const config = {
  ...
  "klay": {
    "quest": {
      ...
      "foraging": {
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          ...
          "268896", "300295", "304598", "1000000072080", "1000000081279", "298992",
      ...
      "goldMining": {
        ...
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          ...
          "1000000058211", "1000000059559", "1000000074522", "1000000088397", "1000000091334", "1000000060859"
        ],
        "minStamina": 25, // 執行任務的最低體力值
        ...
        "quests": [
          {
            ...
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              ...
              "1000000021351", "248925", "1000000029603", "1000000048607",
              "1000000045142", "1000000041965", "1000000029772", "1000000082849",
              "1000000047075", "162779", "162538", "1000000031133", "1000000038180",
          ...
          },
          {
            ...
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              ...
              "1000000017344", "1000000046668", "1000000047716", "1000000040088", "1000000018919", "1000000072530",
            ],
          ...
          },
          {
            "name": "StatQuest_Luk", // 有地方會用到這個值，不要更改它
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              "1000000014120", "208697", "1000000051941", "1000000064162", "1000000055999",
    ...
    "heroForSale": [ // 你想要販售的英雄與價格，price 請填整數，否則會出錯
      ...
      { "id": "1000000017344", "price": 55 },
      { "id": "1000000030913", "price": 75 },
      { "id": "1000000036806", "price": 45 },
      { "id": "1000000072080", "price": 39 },
      { "id": "1000000060859", "price": 55 },
