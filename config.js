...
const config = {
  ...
  "klay": {
    "quest": {
      "fishing": {
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          ...
          "1000000001412", "1000000031708", "1000000092703", "2000000006086",
          "1000000002619", "1000000006002", "1000000091077", "1000000093053",
          "270338", "1000000011636", "1000000091087", "1000000091200",
          "270247", "265263", "295105", "1000000032565", "2000000008084",
          ...
          "284058", "1000000013721", "2000000004564", "1000000109254",
          ...
          "1000000016637", "253125", "1000000091824",
      ...
      "foraging": {
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          ...
          "273563", "238302", "240867", "1000000082262", "2000000009684",
          ...
          "246258", "225740", "273663", "274245", "1000000009838",
      ...
      "goldMining": {
        ...
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          "1000000089287", "1000000091078", "1000000061159", "303804", "208697", "1000000048607",
          "1000000037174", "1000000068248", "1000000052561", "1000000091832", "1000000092705", "1000000021885",
          "1000000058211", "1000000059559", "1000000074522", "1000000091334", "1000000012231", "1000000044536"
        ],
        "minStamina": 25, // 執行任務的最低體力值
      ...
      "jadeMining": {
        ...
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          ...
          "1000000086998", "1000000001443", "1000000088622", "1000000051941", "1000000029603", "1000000064162"
        ],
        "minStamina": 15, // 執行任務的最低體力值
        ...
        "quests": [
          {
            ...
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              ...
              "248925",
              "1000000041965", "1000000029772", "1000000082849",
          ...
          },
          {
            ...
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              ...
              "1000000091097", "2000000004273", "2000000006821", "1000000109415"
            ],
          ...
          },
          {
            "name": "StatQuest_End", // 有地方會用到這個值，不要更改它
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              "1000000038381", "1000000109171", "1000000102496"
            ],
          ...
          },
          {
            "name": "StatQuest_Int", // 有地方會用到這個值，不要更改它
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              "1000000022549", "1000000030734", "296669", "1000000047897", "1000000072500",
    ...
    "heroForSale": [ // 你想要販售的英雄與價格，price 請填整數，否則會出錯
      ...
      { "id": "1000000038324", "price": 49 },
      { "id": "1000000109171", "price": 199 },
      { "id": "1000000010562", "price": 65 },
      { "id": "1000000067657", "price": 75 },
      { "id": "1000000052634", "price": 55 },
      { "id": "197341", "price": 105 },
      { "id": "1000000021312", "price": 75 },
      { "id": "1000000102044", "price": 49 },
      { "id": "1000000036454", "price": 75 },
      { "id": "306585", "price": 75 }
    ],
    "useRpcIndex": 0, // 表示你想要使用的 rpc ，0 是 下方 rpcs 的第一個，1 是第二個以次類推，網路卡頓的時候可以嘗試換個 rpc
    "rpcs": [
