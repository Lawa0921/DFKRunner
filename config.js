...
const config = {
  ...
  "defikingdoms": {
    "quest": {
        "fishing": {
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                ...
                "292069", "169711", "294810", "1000000043741",
        ...
        "foraging": {
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                "300803", "1000000031027", "1000000031167", "1000000073224", "221884",
                ...
                "268896", "278579", "300295", "304598", "1000000072080", "1000000081279",
                ...
                "1000000004431", "1000000040006", "1000000049843",
                "301174", "1000000017108", "1000000040198", "1000000054071",
                "264342", "1000000011969", "290898", "54615", "1000000079906",
                ...
                "302582", "1000000019784", "1000000018930", "294495",
        ...
        "statQuests": [
            {
                ...
                "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                     ...
                     "1000000017145", "1000000045142", "1000000041965", "1000000029772",
    ...
    "heroForSale": [ // 你想要販售的英雄與價格，price 請填整數，否則會出錯
        ...
        { "id": "288226", "price": 109 },
        { "id": "264762", "price": 69 },
        { "id": "1000000038725", "price": 59 },
        { "id": "259371", "price": 85 },
        { "id": "1000000040006", "price": 65 },
        { "id": "296461", "price": 69 },
