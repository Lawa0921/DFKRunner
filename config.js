    ...
    "quest": {
      "fishing": {
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          ...
          "1000000024102", "1000000135155", "1000000139047", "1000000139765",
      ...
      "foraging": {
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          ...
          "259900"       , "1000000138351", "1000000145753"
        ],
        "minStamina": 25, // 執行任務的最低體力值
        ...
        "quests": [
          ...
          },
          {
            ...
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              ...
              "1000000073168", "1000000088471", "1000000029546",
          ...
          },
          {
            ...
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              "1000000026987", "1000000059047", "2000000018790", "1000000032435",
              "1000000079362", "2000000015307", "2000000028749", "1000000133005", "1000000146929"
            ],
          ...
          },
          {
            ...
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              ...
              "1000000015687", "1000000136226", "1000000137771", "273458"       ,
            ],
    ...
    "quest": {
      ...
      "foraging": {
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          ...
          "1000000091332", "1000000094914", "1000000103880", "2000000010501",
          ...
          "1000000004431", "1000000087956", "1000000116931",
