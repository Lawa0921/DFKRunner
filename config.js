...
const config = {
  ...
  "defikingdoms": {
    "quest": {
      "fishing": {
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          ...
          "265263"       , "295105"       , "2000000008084", "1000000131263", "1000000139718",
          ...
          "1000000044846", "2000000016561", "1000000133377", "2000000029334",
          ...
          "1000000051294", "1000000054937", "1000000091920", "1000000150930",
      ...
      "foraging": {
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          ...
          "302481"       , "1000000069438", "2000000002672", "2000000030989",
          ...
          "196393"       , "1000000095474", "2000000010872", "2000000018179",
          ...
          "1000000087956", "1000000116931", "1000000150915",
      ...
      "goldMining": {
        ...
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          ...
          "1000000091334", "1000000012231", "1000000072500", "1000000093700", "2000000009843", "2000000033060"
        ],
        "minStamina": 25, // 執行任務的最低體力值
        ...
        "quests": [
          ...
          },
          {
            ...
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              ...
              "1000000079362", "2000000015307", "2000000028749", "1000000146929",
              "1000000156448"
            ],
          ...
          },
          {
            ...
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              ...
              "1000000015687", "1000000136226", "1000000137771", "273458"       , "2000000032491", "1000000154076",
              "1000000009694", "1000000014478"
            ],
          ...
          },
          {
            ...
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              ...
              "2000000011488", "1000000080354", "1000000159098"
            ],
    ...
    "heroForSale": [ // 你想要販售的英雄與價格，price 請填整數，否則會出錯
      ...
      { "id": "285602", "price": 315 },
      { "id": "214463", "price": 135 }, 
      { "id": "1000000009694", "price": 209 },
      { "id": "1000000014478", "price": 205 }, 
