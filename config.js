...
const config = {
  ...
  "defikingdoms": {
    "quest": {
        ...
        "foraging": {
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                "253628", "300803", "1000000031027", "1000000031167",
                ...
                "274898", "234853", "281743", "253357", "270856",
    ...
    "duelSetting": [ // 注意: 同隻英雄無法同時放入多個不同 type
			...
			},
			{
				...
				"heroes": [["1000000030460", "288226", "285602"], ["1000000041659", "1000000064538", "1000000051353"], ["1000000029707", "1000000038381", "1000000042202"]], // 在這邊寫你想要嘗試送去 duel 的英雄 id squad 範例: [["1234", "5678", "91011"], ["121314", "151617", "181920"]]
			},
			{
