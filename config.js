...
const config = {
  ...
  "klay": {
    "quest": {
      "fishing": {
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          ...
          "269842", "1000000014477", "1000000091827",
          ...
          "240170", "17049", "284245", "1000000073818",
          ...
          "1000000027815", "1000000027762", "1000000044846",
      ...
      "foraging": {
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          ...
          "246344", "283480", "141989", "1000000111575", "2000000011894",
          "249208", "279895", "293588", "1000000036749", "2000000011899",
          "284247", "290757", "298690", "1000000037557",
          "266866", "164343", "1000000001213", "1000000013684",
          "271251", "287332", "287103", "1000000014517",
          "288436", "283539", "287552", "1000000017497", "1000000040065",
          ...
          "103823", "305839", "1000000064538", "1000000090795",
      ...
      "goldMining": {
        ...
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          "1000000089287", "1000000091078", "303804", "208697", "1000000048607", "2000000014240",
        ...
        "quests": [
          ...
          },
          {
            ...
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              ...
              "1000000046668", "1000000047716", "1000000018919", "1000000072530",
            ],
    ...
    "heroForSale": [ // 你想要販售的英雄與價格，price 請填整數，否則會出錯
      ...
      { "id": "1000000072530", "price": 55 },
      { "id": "1000000016290", "price": 189 },
      { "id": "1000000111575", "price": 59 },
      { "id": "2000000010192", "price": 75 }
    ],
    "useRpcIndex": 0, // 表示你想要使用的 rpc ，0 是 下方 rpcs 的第一個，1 是第二個以次類推，網路卡頓的時候可以嘗試換個 rpc
    "rpcs": [
  ...
  "autoBuyerSetting": {
    ...
    "KLAYnetworkBuyerEstimateAdjustment": 0.6, // KLAY 鏈的購買估價會再乘以這個數，如果覺得 KLAY 鏈估價太低或太高可以調整這個數字
