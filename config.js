...
const config = {
  ...
  "defikingdoms": {
    "quest": {
        "fishing": {
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                ...
                "219722", "221301", "269842", "1000000014477", "1000000030913",
                ...
                "254994", "275140", "278240", "185707", "197985", "1000000042559",
                ...
                "276226", "285999", "286436", "1000000005991", "1000000041588",
                ...
                "159893", "301253", "185795", "1000000013535",
                ...
                "1000000059053", "1000000060309", "1000000058992", "1000000064544", "1000000022993",
                "146883", "1000000064305", "1000000062116", "217657"
            ],
            "contractAddress": "0x407ab39B3675f29A719476af6eb3B9E5d93969E6"  //  合約的地址，你不會更改這個值
        },
        "foraging": {
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                "253628", "300803", "1000000013848", "1000000031027", "1000000031167",
                "258169", "257297", "1000000012665", "1000000031261", "1000000034323",
                "194654", "259528", "262265", "302481", "1000000039785",
                "245919", "1000000017180", "303103", "1000000025002", "1000000042867",
                "264398", "268896", "278579", "300295", "304598",
                "218128", "274360", "287938", "1000000020401", "1000000043525",
                ...
                "1000000015604", "271629", "1000000015216", "9371",
                "203884", "281753", "1000000016958", "206456", "205895", "1000000030460",
                ...
                "1000000046811", "1000000051347", "1000000051357", "1000000068137",
        ...
        "goldMining": {
            ...
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                ...
                "267606", "280117", "302782", "1000000033947", "1000000050447",
            ...
            "pairAddressMappings": [
                {
                    ...
                    "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                        "248925", "191055", "1000000029772", "1000000030073", "1000000040088", "1000000052377"
                    ],
                },
                {
                    ...
                    "singleBatchAmount": 2, // 單次送出的英雄數量
                    "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                        "280111", "304918", "280166", "1000000021796", "1000000030876", "249058"
                    ],
                },                 {
        ...
        "statQuests": [
            {
                ...
                "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                     "1000000019693", "1000000018159", "1000000026973", "1000000029603",
                     "1000000017472", "1000000041503", "1000000041547", "1000000043706",
                     "1000000013079", "1000000019603", "1000000021351", "1000000043720",
            ...
            },
            {
                ...
                "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                    ...
                    "1000000049030", "1000000053034", "294416", "1000000068404"
                ],
            ...
            },
            {
                ...
                "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                    "298510", "300829", "304907", "151573", "1000000001443", "1000000061159",
                    "303804", "1000000028133", "1000000037174", "214463",
            ...
            },
            {
                ...
                "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                    "275725", "1000000022549", "1000000027870", "1000000030734", "1000000068100",
            ...
            },
            {
                ...
                "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                    ...
                    "271465", "285793", "294901", "1000000039980", "1000000043421", "1000000066888",
            ...
            },
            {
                ...
                "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                    ...
                    "223260", "171666", "1000000064162", "1000000068214"
                ],
    ...
    "heroForSale": [ // 你想要販售的英雄與價格，price 請填整數，否則會出錯
        ...
        { "id": "131880", "price": 199 },
        { "id": "124147", "price": 55 },
        { "id": "1000000051374", "price": 320 },
        { "id": "1000000033364", "price": 45 },
        { "id": "278033", "price": 59 },
        { "id": "1000000064544", "price": 59 },
        { "id": "1000000022824", "price": 55 },
        { "id": "1000000002241", "price": 65 },
        { "id": "281816", "price": 149 },
        { "id": "1000000051275", "price": 1499 },
        { "id": "265416", "price": 45 },
        { "id": "238735", "price": 59 },
        { "id": "159893", "price": 59 },
        { "id": "282928", "price": 55 },
        { "id": "285939", "price": 55 },
        { "id": "1000000013780", "price": 65 },
        { "id": "230790", "price": 69 },
        { "id": "1000000044616", "price": 79 },
        { "id": "1000000024320", "price": 49 },
        { "id": "304540", "price": 55 },
        { "id": "304907", "price": 55 }
    ],
    ...
    "DFKDuelS1": "0xf724FE22b45D519D149477aA2eC5348Cee08Cae3",
