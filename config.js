...
const config = {
  ...
  "defikingdoms": {
    "quest": {
      "fishing": {
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          ...
          "1000000001412", "1000000031708", "1000000088869", "1000000092703",
          ...
          "1000000051294", "1000000051186", "1000000054937", "1000000091920",
      ...
      "goldMining": {
        ...
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          ...
          "302782", "1000000033947", "1000000050447", "1000000074522", "1000000043706",
          "272569", "96964", "243889", "305904", "1000000052725", "273716", "1000000055666"
        ],
        ...
        "pairAddressMappings": [
          {
            ...
            "singleBatchAmount": 2, // 單次送出的英雄數量
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              "1000000009289", "231246", "185417", "1000000093819"
            ],
          },                 {
      ...
      "statQuests": [
        {
          ...
          "heroes": [ // 這裡面只會寫你自己擁有的 hero id
            "1000000029603", "1000000068348", "1000000074412", "1000000082547",
            ...
            "1000000047075", "1000000048607", "162779", "162538",
        ...
        },
        {
          ...
          "heroes": [ // 這裡面只會寫你自己擁有的 hero id
            ...
            "1000000073168", "1000000081466", "1000000086639", "1000000088471",
            "1000000088633", "1000000085708", "1000000088850", "1000000092139", "1000000093055",
            "1000000093060"
          ],
        ...
        },
        {
          ...
          "heroes": [ // 這裡面只會寫你自己擁有的 hero id
            ...
            "1000000048648", "1000000052634", "1000000052935", "1000000064160", "1000000091826",
            "1000000053380", "1000000072758", "1000000087945", "1000000091835", "1000000093057",
            "1000000088522", "1000000089287", "1000000091078", "1000000091096"
          ],
        ...
        },
        {
          ...
          "heroes": [ // 這裡面只會寫你自己擁有的 hero id
            ...
            "1000000072029", "1000000074522", "1000000088397", "1000000091334"
          ],
        ...
        },
        {
          ...
          "heroes": [ // 這裡面只會寫你自己擁有的 hero id
            ...
            "1000000091831", "1000000092514", "1000000093700"
          ],
        ...
        },
        {
          ...
          "heroes": [ // 這裡面只會寫你自己擁有的 hero id
            "165533", "272697", "1000000025803", "248208", "1000000040104", "1000000060859",
            "285793", "294901", "1000000066888", "1000000091094", "1000000092704",
        ...
        },
        {
          ...
          "heroes": [ // 這裡面只會寫你自己擁有的 hero id
            ...
            "1000000052377", "1000000080531", "1000000086446", "1000000086968",
            "1000000087216", "1000000089072", "1000000089949", "1000000093723"
          ],
    ...
    "heroForSale": [ // 你想要販售的英雄與價格，price 請填整數，否則會出錯
      ...
      { "id": "1000000081466", "price": 45 },
      { "id": "1000000092514", "price": 45 },
      { "id": "1000000086705", "price": 45 },
      { "id": "276198", "price": 79 },
      { "id": "1000000086890", "price": 45 },
      { "id": "1000000019201", "price": 55 },
      { "id": "1000000093055", "price": 55 },
      { "id": "1000000086446", "price": 49 },
      { "id": "1000000087025", "price": 49 },
      { "id": "1000000061517", "price": 59 },
      { "id": "1000000088518", "price": 59 },
      { "id": "1000000089295", "price": 49 },
      { "id": "1000000086884", "price": 49 },
      { "id": "1000000093723", "price": 45 },
      { "id": "1000000087026", "price": 45 },
      { "id": "1000000088522", "price": 42 },
      { "id": "1000000088869", "price": 65 },
      { "id": "306304", "price": 55 },
      { "id": "1000000093819", "price": 145 },
      { "id": "1000000089949", "price": 59 },
      { "id": "1000000087829", "price": 52 }
    ],
    ...
    "newworkRentalEstimateAdjustment": 1 // DFK 鏈的出租估價完會在乘以這個數，如果覺得 DFK 鏈估價太低或太高可以調整這個數字
  },
  "klay": {
    "quest": {
      "fishing": {
      ...
      "foraging": {
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          ...
          "245919", "303103", "1000000025002", "1000000091332",
          ...
          "203884", "281753", "206456", "1000000030460",
    ...
    "heroForSale": [ // 你想要販售的英雄與價格，price 請填整數，否則會出錯
      // 格式範例 { "id": "1234", "price": 25000 }
      { "id": "2000000000175", "price": 37999 },
      { "id": "2000000000171", "price": 12500 }
    ],
    "useRpcIndex": 0, // 表示你想要使用的 rpc ，0 是 下方 rpcs 的第一個，1 是第二個以次類推，網路卡頓的時候可以嘗試換個 rpc
    "rpcs": [
    ...
    "overBaseGasFeeWei": 550000000, // 表示你願意出高於 baseFee 多少的 gas，理論上這個數字越高你的交易速度就會越快， 110000000 表示 0.11 Gwei，請依你的需要調整
    "listStamina": 24, // 表示當你的英雄體力低於多少時要進行掛售，體力值高於這個設定的英雄如果是下架狀態會等做完任務才會再次上架
    "newworkRentalEstimateAdjustment": 0.8 // KLAY 鏈的出租估價完會在乘以這個數，如果覺得 KLAY 鏈估價太低或太高可以調整這個數字
  },
