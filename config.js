...
const config = {
    ...
    "quest": {
        "fishing": {
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                ...
                "272686", "301639", "304540", "305852", "305635", "1000000022759",
                "1000000016637", "1000000018997", "253125", "1000000047143",
                "258640", "303692", "1000000021634", "1000000023115", "1000000047447",
        ...
        "foraging": {
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                ...
                "194654", "259528", "262265", "302481", "1000000039785", "1000000069438",
            ...
            "pairAddressMappings": [
                {
                    ...
                    "singleBatchAmount": 2, // 單次送出的英雄數量
                    "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                        "291333", "236563", "265416", "1000000022107", "1000000038180", "1000000067657"
                    ],
                },                 {
        ...
        "statQuests": [
            {
                ...
                "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                     "1000000019693", "1000000018159", "1000000026973", "1000000029603", "1000000068348",
            ...
            },
            {
                ...
                "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                    "1000000038262", "1000000043531", "1000000047704", "1000000063769", "1000000070737",
    ...
    "duelSetting": [ // 注意: 同隻英雄無法同時放入多個不同 type
			{
				...
				"heroes": [["1000000030460"], ["1000000064538"]], // 在這邊寫你想要嘗試送去 duel 的英雄 id solo 範例: [["1234"], ["5678"], ["91011"]]
			},
			{
				"type": "squad", // duel 的類型，你不會更改這個值
				"fee": "low", // 花費幣的數量 low = 0.3 medium = 1.5 large = 3
				"isActive": false, // 表示是否要執行該 type 的 duel，true 的情形就會自動執行
				"heroes": [], // 在這邊寫你想要嘗試送去 duel 的英雄 id squad 範例: [["1234", "5678", "91011"], ["121314", "151617", "181920"]]
			},
			{
  ...
  "setDuelScriptTimeSecond": 120, // 設定你每次執行 duel 腳本的間隔秒數
