...
const config = {
  ...
  "defikingdoms": {
    ...
    "heroForSale": [ // 你想要販售的英雄與價格，price 請填整數，否則會出錯
      ...
      { "id": "272569", "price": 149 },
      { "id": "273716", "price": 169 },
      { "id": "1000000029882", "price": 219 },
      { "id": "1000000021036", "price": 169 }
    ],
  ...
  "klay": {
    "quest": {
      "fishing": {
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          ...
          "270247", "265263", "295105", "1000000032565",
      ...
      "foraging": {
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          ...
          "303103", "1000000091332", "1000000094914", "1000000103880",
          "268896", "300295", "304598", "1000000081279", "298992",
          "218128", "1000000020401", "1000000043525", "1000000081555", "1000000101015",
          "273563", "238302", "240867", "1000000082262",
          "273379", "295054", "1000000010814", "1000000015214", "1000000058189",
          "274898", "281743", "270856", "1000000066747",
          "196393", "239243", "169406", "273072", "1000000095474",
          "246258", "225740", "273663", "274245", "254782", "1000000009838",
          "276198", "273818", "277774", "182721", "114122", "1000000043522",
          "246344", "283480", "141989", "1000000036454",
          "259371", "249208", "279895", "293588", "1000000036749", "1000000102044",
          ...
          "1000000004431", "1000000083536", "1000000087956",
          "301174", "1000000054071", "1000000100455", "2000000005161",
      ...
      "goldMining": {
        ...
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          "1000000089287", "1000000091078", "1000000061159", "303804", "208697", "1000000058157",
          "1000000037174", "1000000068248", "1000000052561", "1000000091832", "1000000092705", "1000000021885",
          "1000000058211", "1000000059559", "1000000074522", "1000000091334", "1000000012231", "1000000100179"
        ],
        "minStamina": 25, // 執行任務的最低體力值
      ...
      "jadeMining": {
        "singleBatchAmount": 6, // 單次送出的英雄數量
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          "1000000038262", "1000000047704", "1000000073976", "1000000072758", "1000000062264", "1000000021351",
          "1000000025803", "248208", "1000000017472", "2000000000175", "1000000043706", "1000000055666",
          "1000000086998", "1000000001443", "1000000047075", "1000000088622", "1000000051941", "1000000029603"
        ],
        "minStamina": 15, // 執行任務的最低體力值
        ...
        "pairAddressMappings": [
          {
            ...
            "singleBatchAmount": 2, // 單次送出的英雄數量
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              "1000000053380", "1000000052935", "246617", "249058", "252348", "257441"
            ],
          },                 {
            ...
            "singleBatchAmount": 2, // 單次送出的英雄數量
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              "1000000052634", "260126", "262381", "1000000085708", "269798", "274333"
            ],
          },                 {
            ...
            "singleBatchAmount": 2, // 單次送出的英雄數量
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              "294416", "214463", "285602", "265142", "1000000009694", "1000000014478"
            ],
          },                 {
        ...
        "quests": [
          {
            "name": "StatQuest_Str", // 有地方會用到這個值，不要更改它
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              "1000000041503", "1000000041547", "1000000085774", "1000000067657",
              "248925", "1000000048607",
              "1000000045142", "1000000041965", "1000000029772", "1000000082849",
              "162779", "162538", "1000000031133", "1000000038180",
              "1000000051353", "1000000052246", "1000000024773", "1000000087935",
              "1000000087038",
              "1000000091083", "1000000000528"
            ],
          ...
          },
          {
            "name": "StatQuest_Agi", // 有地方會用到這個值，不要更改它
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              "1000000027626", "1000000030876", "1000000036507", "1000000037933", "1000000038061", "1000000038324",
              "1000000091097", "2000000004273", "2000000006821"
            ],
          ...
          },
          {
            "name": "StatQuest_Vit", // 有地方會用到這個值，不要更改它
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              "1000000026987", "1000000028544", "1000000032435", "1000000053360", "1000000059047",
              "1000000079362", "185295", "300815"
            ],
          ...
          },
          {
            "name": "StatQuest_Int", // 有地方會用到這個值，不要更改它
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              "1000000022549", "1000000030734", "296669", "1000000047897", "1000000044536", "1000000072500",
              "1000000091831", "1000000093700", "1000000046841", "1000000091089", "1000000104556"
            ],
          ...
          },
          {
            "name": "StatQuest_Wis", // 有地方會用到這個值，不要更改它
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              "285793", "294901", "1000000066888", "1000000091094", "1000000092704", "1000000016650",
              "1000000046668", "1000000047716", "1000000040088", "1000000018919", "1000000072530",
            ],
          ...
          },
          {
            "name": "StatQuest_Luk", // 有地方會用到這個值，不要更改它
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              "1000000014120", "1000000064162", "1000000055999",
    ...
    "notForLevelUpHeroIds": [
      "1000000031392" // 把你不想自動升級的英雄 ID 寫在這裡，例如： "1716", "123456"
    ],
    "useStaminaVialHeroIds": [ // 把你想要自動使用耐力藥水的英雄 ID 寫在這裡，例如 "1000000064538"
    ...
    "heroForSale": [ // 你想要販售的英雄與價格，price 請填整數，否則會出錯
      ...
      { "id": "1000000038262", "price": 85 },
      { "id": "1000000047143", "price": 79 },
      { "id": "1000000030913", "price": 75 },
      { "id": "287682", "price": 75 },
      { "id": "1000000092703", "price": 35 },
      { "id": "1000000043525", "price": 65 },
      { "id": "1000000058157", "price": 59 },
      { "id": "1000000045142", "price": 65 },
      { "id": "1000000086998", "price": 69 },
      { "id": "271813", "price": 75 },
      { "id": "1000000012665", "price": 59 },
      { "id": "2000000003160", "price": 49 }
    ],
    "useRpcIndex": 0, // 表示你想要使用的 rpc ，0 是 下方 rpcs 的第一個，1 是第二個以次類推，網路卡頓的時候可以嘗試換個 rpc
    "rpcs": [
  ...
  "autoBuyerSetting": {
    ...
    "KLAYnetworkBuyerEstimateAdjustment": 0.35, // KLAY 鏈的購買估價會再乘以這個數，如果覺得 KLAY 鏈估價太低或太高可以調整這個數字
