...
const config = {
  ...
  "defikingdoms": {
    "quest": {
        ...
        "goldMining": {
            ...
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                ...
                "302782", "1000000033947", "1000000050447", "1000000046207", "1000000047244", "1000000074522",
            ...
            "pairAddressMappings": [
                {
                    ...
                    "singleBatchAmount": 2, // 單次送出的英雄數量
                    "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                        "291333", "236563", "1000000038180", "1000000067657", "1000000079362", "1000000026987"
                    ],
                },                 {
        ...
        "statQuests": [
            {
                ...
                "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                     ...
                     "1000000047075", "1000000048340", "1000000048607",
            ...
            },
            {
                ...
                "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                    ...
                    "1000000053380", "1000000055666", "1000000072758"
                ],
    ...
    "heroForSale": [ // 你想要販售的英雄與價格，price 請填整數，否則會出錯
        ...
        { "id": "1000000049166", "price": 65 },
        { "id": "292069", "price": 59 },
        { "id": "1000000048340", "price": 45 },
        { "id": "193857", "price": 75 },
