...
const config = {
  ...
  "defikingdoms": {
    "quest": {
        "fishing": {
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                ...
                "1000000022764", "1000000076100", "1000000074719",
        ...
        "foraging": {
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                ...
                "273563", "238302", "240867", "293836", "1000000018502",
            ...
            "pairAddressMappings": [
                {
                    ...
                    "singleBatchAmount": 2, // 單次送出的英雄數量
                    "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                        "235467", "261081", "1000000031894", "1000000055999", "1000000059047"
                    ],
                },                 {
    ...
    "notForLevelUpHeroIds": [
        "1716"// 把你不想自動升級的英雄 ID 寫在這裡，例如： "1716", "123456"
    ],
    "heroForSale": [ // 你想要販售的英雄與價格，price 請填整數，否則會出錯
        ...
        { "id": "1000000051347", "price": 149 },
        { "id": "259371", "price": 85 },
        { "id": "1000000040006", "price": 65 },
        { "id": "1000000022764", "price": 65 },
        { "id": "296461", "price": 69 },
        { "id": "1000000025572", "price": 65 },
        { "id": "1000000042202", "price": 65 },
        { "id": "1000000049166", "price": 65 },
        { "id": "1000000046811", "price": 45 },
        { "id": "1000000037439", "price": 55 },
        { "id": "292069", "price": 59 },
        { "id": "169711", "price": 129 },
        { "id": "293836", "price": 55 }
    ],
  ...
  "setDuelScriptTimeSecond": 20, // 設定你每次執行 duel 腳本的間隔秒數
