...
const config = {
        ...
        "quests": [
          {
            ...
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              "1000000019603", "1000000029603", "1000000048607"
            ],
          ...
          },
          {
            ...
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              ...
              "171666", "1000000064162", "1000000068214", "1000000069970",
  ...
  "klay": {
        ...
        "quests": [
          {
            "name": "StatQuest_Str", // 有地方會用到這個值，不要更改它
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              "2000000000175", "1000000090424", "1000000074412", "1000000082547",
          ...
          },
          {
            "name": "StatQuest_Dex", // 有地方會用到這個值，不要更改它
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              "1000000092583", "1000000092139", "1000000012231", "1000000021885", "1000000018216", "1000000041938",
    ...
    "heroForSale": [ // 你想要販售的英雄與價格，price 請填整數，否則會出錯
      ...
      { "id": "273563", "price": 89 },
      { "id": "1000000088518", "price": 55 },
      { "id": "1000000082547", "price": 105 },
      { "id": "1000000086884", "price": 49 },
      { "id": "1000000090711", "price": 49 },
      ...
      { "id": "1000000091835", "price": 45 },
      { "id": "1000000092139", "price": 45 },
      { "id": "303103", "price": 95 },
      { "id": "221872", "price": 89 },
      { "id": "253125", "price": 65 },
      { "id": "263373", "price": 65 },
    ...
    "overBaseGasFeeWei": 550000000, // 表示你願意出高於 baseFee 多少的 gas，理論上這個數字越高你的交易速度就會越快， 110000000 表示 0.11 Gwei，請依你的需要調整
    "listStamina": 24, // 表示當你的英雄體力低於多少時要進行掛售，體力值高於這個設定的英雄如果是下架狀態會等做完任務才會再次上架
    "newworkRentalEstimateAdjustment": 0.9 // KLAY 鏈的出租估價完會在乘以這個數，如果覺得 KLAY 鏈估價太低或太高可以調整這個數字
  },
