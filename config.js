...
const config = {
  ...
  "defikingdoms": {
    "quest": {
      "fishing": {
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          ...
          "1000000002619", "1000000006002", "1000000091077", "1000000138985", "285499"       ,
          ...
          "256447"       , "158263"       , "275612"       , "277968"       , "1000000036881",
      ...
      "foraging": {
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          ...
          "246258"       , "225740"       , "273663"       , "2000000043049",
          ...
          "301809"       , "1000000012216", "1000000085578", "2000000043171",
          "2000000024565", "1000000015216", "9371"         , "1000000131490",
          ...
          "228546"       , "2000000030717", "1000000022203", "1000000026278",
        ...
        "pairAddressMappings": [
          {
            ...
            "singleBatchAmount": 2, // 單次送出的英雄數量
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              "210943", "1000000127319", "249058", "208971", "1000000138236"
            ],
          },                 {
        ...
        "quests": [
          {
            ...
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              ...
              "1000000120304", "1000000041965", "162779"       , "162538"       , "1000000155936",
          ...
          },
          {
            ...
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              ...
              "1000000079362", "2000000015307", "2000000028749", "1000000146929", "1000000160286",
          ...
          },
          {
            ...
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              "1000000038381", "1000000102496", "1000000112309", "2000000017896", "2000000044111",
          ...
          },
          {
            ...
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              "1000000030734", "296669"       , "1000000047897", "2000000024175", "1000000138253",
              "1000000091089", "1000000149027", "1000000158815", "1000000166732", "1000000155396",
    ...
    "heroForSale": [ // 你想要販售的英雄與價格，price 請填整數，否則會出錯
      ...
      { "id": "1000000030734", "price": 175 },
      { "id": "1000000059053", "price": 149 },
      { "id": "291845", "price": 139 },
      { "id": "1000000079362", "price": 99 },
  ...
  "klay": {
    ...
    "overBaseGasFeeWei": 100000000, // 表示你願意出高於 baseFee 多少的 gas，理論上這個數字越高你的交易速度就會越快， 110000000 表示 0.11 Gwei，請依你的需要調整
    "listStamina": 24, // 表示當你的英雄體力低於多少時要進行掛售，體力值高於這個設定的英雄如果是下架狀態會等做完任務才會再次上架
  },
  "autoBuyerSetting": {
