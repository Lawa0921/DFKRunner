...
const config = {
      ...
      "statQuests": [
        ...
        },
        {
          ...
          "heroes": [ // 這裡面只會寫你自己擁有的 hero id
            ...
            "1000000088633", "1000000085708", "1000000088850", "1000000092139",
            "1000000093060"
          ],
        ...
        },
        {
          ...
          "heroes": [ // 這裡面只會寫你自己擁有的 hero id
            "1000000022549", "1000000030734", "1000000089295",
        ...
        },
        {
          ...
          "heroes": [ // 這裡面只會寫你自己擁有的 hero id
            "272697", "1000000025803", "248208", "1000000040104", "1000000060859",
        ...
        },
        {
          ...
          "heroes": [ // 這裡面只會寫你自己擁有的 hero id
            ...
            "1000000052377", "1000000080531", "1000000086968",
  ...
  "klay": {
    ...
    "heroForSale": [ // 你想要販售的英雄與價格，price 請填整數，否則會出錯
      // 格式範例 { "id": "1234", "price": 25000 }
      { "id": "2000000000175", "price": 23999 },
      { "id": "2000000000171", "price": 8500 },
      { "id": "203884", "price": 75 },
      { "id": "1000000019201", "price": 55 },
      { "id": "1000000086890", "price": 30 },
      { "id": "1000000009224", "price": 55 },
      { "id": "169406", "price": 99 },
      { "id": "1000000004962", "price": 59 },
      { "id": "245919", "price": 119 },
      { "id": "230218", "price": 65 },
      { "id": "259371", "price": 55 },
      { "id": "254782", "price": 55 },
      ...
      { "id": "273818", "price": 75 },
      { "id": "271629", "price": 49 },
      { "id": "1000000009838", "price": 45 },
      { "id": "288177", "price": 55 },
      { "id": "262265" ,"price": 55 },
      { "id": "1000000010242", "price": 49 },
      { "id": "1000000027116", "price": 45 },
      { "id": "295105", "price": 59 },
      { "id": "284058", "price": 45 },
      { "id": "292587", "price": 69 },
      { "id": "292069", "price": 39 },
      { "id": "1000000088518", "price": 39 },
      { "id": "288226", "price": 69 },
      { "id": "1000000026652", "price": 35 },
      { "id": "276051", "price": 55 },
      { "id": "1000000027759", "price": 39 },
      { "id": "1000000011636", "price": 55 },
      { "id": "1000000013721", "price": 35 },
      { "id": "296461", "price": 35 },
      { "id": "286148", "price": 45 },
      { "id": "1000000015992", "price": 45 },
      { "id": "1000000087829", "price": 35 },
      { "id": "221301", "price": 45 },
      { "id": "225412", "price": 45 },
      { "id": "1000000087026", "price": 29 },
    ],
    "useRpcIndex": 0, // 表示你想要使用的 rpc ，0 是 下方 rpcs 的第一個，1 是第二個以次類推，網路卡頓的時候可以嘗試換個 rpc
    "rpcs": [
