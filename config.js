...
const config = {
  ...
  "defikingdoms": {
    "quest": {
      "fishing": {
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          ...
          "270822"       , "2000000023906", "1000000146983", "2000000032841", "1000000222046",
      ...
      "foraging": {
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          ...
          "1000000034323", "1000000093697", "1000000101015", "1000000160911", "2000000119137",
          ...
          "300295"       , "298992"       , "2000000105710", "1000000221986", "1000000222017",
          ...
          "2000000018179", "2000000034356", "2000000038537", "2000000063222", "1000000222025",
          ...
          "228546"       , "2000000030717", "1000000192365", "2000000064283", "1000000222505",
          ...
          "1000000065836", "2000000024104", "1000000167132", "1000000222516",
        ...
        "pairAddressMappings": [
          {
            ...
            "singleBatchAmount": 2, // 單次送出的英雄數量
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              "2000000004106", "1000000127765", "1000000138230", "1000000139085", "1000000139091"
            ],
          },                 {
        ...
        "quests": [
          {
            ...
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              ...
              "2000000026348", "256082"       , "1000000153919", "1000000031133", "2000000103915",
              ...
              "1000000221984", "1000000222018", "1000000222021", "1000000222059", "1000000222494"
            ],
          ...
          },
          {
            ...
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              ...
              "1000000073168", "2000000033061", "1000000155004", "2000000066143",
          ...
          },
          {
            ...
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              ...
              "2000000015218", "1000000082393", "1000000138250", "211146"       ,
          ...
          },
          {
            ...
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              "294901"       , "1000000091094", "1000000092704", "1000000047716", "1000000222048",
          ...
          },
          {
            ...
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              "1000000014120", "1000000087216", "1000000142831", "1000000139174",
    ...
    "heroForSale": [ // 你想要販售的英雄與價格，price 請填整數，否則會出錯
      ...
      { "id": "1000000222017", "price": 119 },
      { "id": "1000000222018", "price": 119 },
      { "id": "1000000222021", "price": 399 },
      { "id": "1000000222022", "price": 85 },
      { "id": "1000000222024", "price": 125 },
      { "id": "1000000222025", "price": 115 },
