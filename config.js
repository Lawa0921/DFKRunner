...
const config = {
  ...
  "defikingdoms": {
    "quest": {
        "fishing": {
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                ...
                "219723", "211172", "225412", "265329", "155527", "1000000031003",
                ...
                "244783", "270247", "265263", "292587", "295105", "1000000032565",
                "240170", "17049", "263373", "284245", "1000000033210", "1000000033364",
                "238435", "245862", "264762", "276051", "284017", "296461", "1000000042496",
                "248625", "266063", "272671", "274892", "278390", "1000000034480",
                ...
                "286148", "287580", "288122", "291845", "295324", "1000000036746",
                ...
                "1000000024698", "1000000026652", "1000000021632", "1000000026771", "1000000027759",
                ...
                "1000000051289", "1000000051294", "1000000051362", "1000000051374"
            ],
        ...
        "foraging": {
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                ...
                "1000000004177", "301174", "1000000017108", "1000000040198",
                ...
                "193857", "1000000020648", "103823", "143984", "1000000030678",
                ...
                "1000000027116", "1000000025876", "1000000027440", "292136", "292255",
                "1000000046811", "1000000051347", "1000000051357", "1000000051379"
            ],
            ...
            "pairAddressMappings": [
                {
                    ...
                    "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                        "25442", "248925", "191055", "1000000026573", "1000000029772", "1000000030073"
                    ],
                },
                {
                    ...
                    "singleBatchAmount": 2, // 單次送出的英雄數量
                    "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                        "1000000009694", "1000000013454", "1000000005579", "306400", "1000000025572", "131880"
                    ],
                },                 {
                    ...
                    "singleBatchAmount": 2, // 單次送出的英雄數量
                    "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                        "272143", "1000000009289", "238735", "231246", "1000000015231", "1000000038725"
                    ],
                },                 {
                    ...
                    "singleBatchAmount": 2, // 單次送出的英雄數量
                    "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                        "291670", "284716", "235467", "261081", "1000000019977", "1000000031894"
                    ],
                },                 {
        ...
        "statQuests": [
            {
                ...
                "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                     ...
                     "264321", "1000000013079", "1000000019603", "1000000021351", "1000000022817", "1000000043720",
                     "1000000017145", "1000000044252", "1000000044616", "1000000045142", "1000000045199",
                     "1000000046207", "1000000047075", "1000000047244", "1000000048340", "1000000048607",
                     "1000000051275", "1000000051353", "1000000052246"
                ],
            ...
            },
            {
                ...
                "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                    ...
                    "1000000049030", "1000000051702", "1000000052245"
                ],
            ...
            },
            {
                ...
                "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                    "298510", "300829", "304907", "1000000021550", "151573", "1000000001443",
            ...
            },
            {
                ...
                "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                    "1000000025735", "1000000019265", "1000000038262", "1000000043531", "1000000047704",
                    "1000000048648", "1000000051386", "1000000052634"
                ],
            ...
            },
            {
                ...
                "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                    "273716", "1000000017580", "1000000042880"
                ],
            ...
            },
            {
                ...
                "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                    "275725", "1000000022549", "1000000027870", "1000000030734", "1000000048330",
                    "296669", "1000000007008", "1000000047897", "1000000051394",
                    "1000000002241",
                ],
            ...
            },
            {
                ...
                "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                    "165533", "171763", "271802", "272697", "1000000025803", "248208", "1000000040104",
                    "271465", "285793", "294901", "1000000030492", "1000000039980", "1000000043421",
                    "1000000017344", "1000000040088", "1000000046668", "1000000047716", "1000000051343"
                ],
            ...
            },
            {
                ...
                "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                    "1000000014120", "208697", "1000000001760", "1000000051941"
                ],
    ...
    "heroForSale": [ // 你想要販售的英雄與價格，price 請填整數，否則會出錯
        ...
        { "id": "1000000045199", "price": 49 },
        { "id": "1000000048244", "price": 69 },
        { "id": "1000000048330", "price": 149 },
        { "id": "1000000051275", "price": 3298 },
        { "id": "1000000051343", "price": 75 },
        { "id": "1000000051362", "price": 35 },
        { "id": "1000000051394", "price": 59 },
        { "id": "1000000052245", "price": 55 }
    ],
  ...
  "setQuestScriptTimeSecond": 150, // 設定你每次任務腳本執行的間隔秒數
