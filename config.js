...
const config = {
    ...
    "quest": {
      "fishing": {
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          ...
          "245862", "1000000042496", "1000000091342",
          ...
          "262570", "279365", "280215", "218529", "1000000042854",
          ...
          "294810", "1000000087664", "1000000129706",
          ...
          "197215", "1000000022526", "1000000024102",
      ...
      "goldMining": {
        ...
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          ...
          "1000000058211", "1000000074522", "1000000091334", "1000000012231", "1000000072500", "285793"
        ],
        "minStamina": 25, // 執行任務的最低體力值
      ...
      "crystalMining": {
        ...
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          "235300", "96964", "1000000052725", "273716", "2000000026021",
        ...
        "pairAddressMappings": [
          {
            ...
            "singleBatchAmount": 2, // 單次送出的英雄數量
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              "210943", "1000000127319", "249058", "252348"
            ],
          },                 {
            ...
            "singleBatchAmount": 2, // 單次送出的英雄數量
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              "1000000053380", "1000000052935", "246617", "2000000001685"
            ],
          },                 {
            ...
            "singleBatchAmount": 2, // 單次送出的英雄數量
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              "1000000003941", "1000000009289", "1000000063769", "1000000011052", "1000000014451"
            ],
          },                 {
            ...
            "singleBatchAmount": 2, // 單次送出的英雄數量
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              "1000000003004", "252748", "171666", "1000000069970", "2000000007607", "2000000027098"
            ],
          },                 {
      ...
      "statQuest": {
        ...
        "quests": [
          ...
          },
          {
            ...
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              "1000000038381", "1000000102496", "1000000112309", "2000000017896", "2000000027204"
            ],
  ...
  "klay": {
    "quest": {
      ...
      "foraging": {
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          ...
          "273379", "1000000010814", "1000000015214", "1000000058189",
          "274898", "281743", "270856", "1000000066747", "2000000003713", "2000000025071",
          ...
          "1000000054071", "1000000100455", "2000000005161",
          ...
          "1000000015216", "9371", "1000000073518",
          ...
          "294495", "1000000083984", "1000000088328",
          "103823", "305839", "1000000064538", "1000000090795", "1000000110042",
          "228546", "1000000041812", "141028", "1000000106927",
    ...
    "heroForSale": [ // 你想要販售的英雄與價格，price 請填整數，否則會出錯
      ...
      { "id": "1000000024777", "price": 85 },
      { "id": "1000000088328", "price": 165 },
      { "id": "1000000058189", "price": 85 },
      { "id": "257297", "price": 85 },
