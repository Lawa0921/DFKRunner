...
const config = {
  ...
  "klay": {
    "quest": {
      "fishing": {
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          ...
          "1000000054083", "2000000009502", "2000000003420",
          ...
          "1000000053737", "1000000055672", "299980", "2000000011428", "2000000024155",
      ...
      "foraging": {
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          ...
          "249208", "293588", "2000000011899", "2000000015254",
          "284247", "290757", "298690", "1000000037557", "2000000016937",
          "266866", "164343", "1000000013684", "1000000116288",
          ...
          "1000000019201", "1000000019288", "1000000081555",
          ...
          "1000000051357", "1000000068137", "1000000071597", "1000000091353", "2000000024165",
          "1000000060323", "1000000052155", "1000000062345", "1000000065836", "2000000024104", "2000000024106"
        ],
        "minStamina": 25, // 執行任務的最低體力值
        ...
        "quests": [
          {
            ...
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              ...
              "248925", "1000000120304", "1000000041965", "162779", "162538", "1000000031133", "1000000038180",
              "1000000051353", "1000000052246", "1000000087935", "1000000087038", "1000000000528",
              "2000000024151"
            ],
          ...
          },
          {
            "name": "StatQuest_Int", // 有地方會用到這個值，不要更改它
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              "1000000022549", "1000000030734", "296669", "1000000047897", "2000000024175",
          ...
          },
          {
            "name": "StatQuest_Luk", // 有地方會用到這個值，不要更改它
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              "1000000014120", "1000000087216", "1000000089072", "2000000024115"
            ],
    ...
    "heroForSale": [ // 你想要販售的英雄與價格，price 請填整數，否則會出錯
      ...
      { "id": "240867", "price": 129 },
      { "id": "1000000015604", "price": 119 },
      { "id": "1000000018919", "price": 119 },
      { "id": "1000000057512", "price": 65 },
      { "id": "278240", "price": 89 },
      { "id": "1000000044536", "price": 79 },
      { "id": "1000000091342", "price": 75 },
      { "id": "1000000068248", "price": 85 },
      { "id": "1000000043741", "price": 75 },
      { "id": "290757", "price": 159 },
      { "id": "1000000029772", "price": 95 },
      { "id": "1000000055808", "price": 109 },
      { "id": "1000000019670", "price": 85 },
      { "id": "114122", "price": 99 },
      { "id": "1000000011527", "price": 89 },
      { "id": "1000000012524", "price": 79 },
      { "id": "1000000043522", "price": 59 },
      { "id": "214463", "price": 99 },
      { "id": "1000000082262", "price": 75 },
      { "id": "1000000082209", "price": 85 },
      { "id": "2000000014240", "price": 950 },
      { "id": "1000000083536", "price": 59 },
      { "id": "1000000011698", "price": 69 },
      { "id": "1000000022759", "price": 299 },
      { "id": "291333", "price": 115 },
      { "id": "197985", "price": 105 },
      { "id": "271251", "price": 199 },
      { "id": "269842", "price": 99 },
      { "id": "304598", "price": 69 },
      { "id": "1000000022203", "price": 89 },
      { "id": "2000000011899", "price": 249 },
      { "id": "273663", "price": 135 },
      { "id": "249058", "price": 219 },
      { "id": "1000000059053", "price": 99 },
      { "id": "1000000041503", "price": 65 },
      { "id": "1000000091824", "price": 75 },
      { "id": "224608", "price": 79 },
      { "id": "1000000037933", "price": 99 },
      { "id": "1000000093060", "price": 89 },
      { "id": "1000000092704", "price": 119 },
      { "id": "239243", "price": 349 },
      { "id": "292255", "price": 149 },
      { "id": "1000000052561", "price": 139 },
      { "id": "270338", "price": 89 },
      { "id": "301253", "price": 89 },
      { "id": "1000000079906", "price": 79 },
      { "id": "171531", "price": 155 },
      { "id": "2000000019796", "price": 59 },
      { "id": "1000000069438", "price": 79 }
    ],
    "useRpcIndex": 0, // 表示你想要使用的 rpc ，0 是 下方 rpcs 的第一個，1 是第二個以次類推，網路卡頓的時候可以嘗試換個 rpc
    "rpcs": [
    ...
    "duelSetting": {
      ...
      "heroes": [ 
        ...
        */
          ...
          "1000000047585", "1000000048766", "1000000049957", "1000000091425",
          "1000000051294", "1000000054937", "1000000091920", "2000000009909",
          "1000000053737", "1000000055672", "299980", "2000000011428",
          "1000000059053", "1000000060309", "1000000058992", "1000000022993",
          "146883", "1000000062116", "217657", "1000000063338", "2000000015620",
          "1000000066026", "1000000070764", "1000000071159", "1000000070361", "2000000011778",
          "300803", "1000000031167", "1000000073224", "221884", "1000000087219", "2000000005475",
          ...
          "1000000027626", "1000000030876", "1000000036507", "1000000037933", "1000000038061",
          "1000000091097", "2000000004273", "2000000006821", "1000000109415", "2000000005262",
          "2000000015218", "1000000026987", "1000000028544", "1000000032435", "1000000059047", "2000000018790",
          "1000000079362", "300815", "2000000015307", "1000000038381", "1000000102496", "1000000112309", "2000000017896",
          "1000000022549", "1000000030734", "296669", "1000000047897", "2000000024175",
          "1000000093700", "1000000046841", "1000000091089", "2000000024151",
          "1000000111795", "2000000003586", "2000000021216", "2000000024165",
          "285793", "294901", "1000000066888", "1000000091094", "1000000092704", "1000000120931",
          "1000000047716", "1000000018919", "1000000014120", "1000000087216", "1000000089072"
      ]
    },
