...
const config = {
  ...
  "defikingdoms": {
    "quest": {
      "fishing": {
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          ...
          "270338", "1000000011636", "1000000019366", "1000000091087",
      ...
      "statQuests": [
        ...
        },
        {
          ...
          "heroes": [ // 這裡面只會寫你自己擁有的 hero id
            "300829", "1000000001443", "1000000061159", "1000000085586",
        ...
        },
        {
          ...
          "heroes": [ // 這裡面只會寫你自己擁有的 hero id
            ...
            "1000000048648", "1000000052634", "1000000052935", "1000000064160",
    ...
    "notForRentHeroIds": [
      "1000000086705", "1000000085586",
      "1000000086890", "1000000084960", "1000000088518", "1000000088522", "1000000086648", "1000000087823",
      "1000000086884", "1000000061517", "1000000088869", "306304", "1000000089295", "1000000087025",
      "1000000086446", "1000000087026", "1000000089949", "1000000087829" // 把你不想出租的英雄 ID 寫在這裡，例如： "1565", "1234" 
    ],
    ...
    "heroForSale": [ // 你想要販售的英雄與價格，price 請填整數，否則會出錯
      ...
      { "id": "1000000031261", "price": 65 },
      { "id": "1000000046207", "price": 75 },
      { "id": "1000000091099", "price": 42 },
      { "id": "1000000081466", "price": 45 },
      { "id": "1000000083930", "price": 42 },
      { "id": "1000000040198", "price": 49 },
      { "id": "1000000039706", "price": 59 }
    ],
