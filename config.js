...
const config = {
  ...
  "defikingdoms": {
      ...
      "statQuest": {
        ...
        "quests": [
          ...
          },
          {
            ...
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              "1000000001443", "1000000061159",
              "303804", "1000000028133", "1000000037174", "214463", "1000000068248",
              "1000000052561", "285602", "1000000072014",
              "1000000091832", "1000000092705"
            ],
          ...
          },
          {
            ...
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              "1000000025803", "248208", "1000000040104", "1000000060859",
    ...
    "newworkRentalEstimateAdjustment": 1.1 // DFK 鏈的出租估價完會在乘以這個數，如果覺得 DFK 鏈估價太低或太高可以調整這個數字
  },
  "klay": {
    "quest": {
      "fishing": {
      ...
      "foraging": {
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          ...
          "302481", "1000000039785", "1000000069438", "1000000080914",
      ...
      "goldMining": {
        "singleBatchAmount": 6, // 單次送出的英雄數量
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          "1000000064160", "1000000072758", "1000000087945", "1000000091835", "1000000089287", "1000000091078"
        ],
        "minStamina": 25, // 執行任務的最低體力值
      ...
      "jadeMining": {
        "singleBatchAmount": 1, // 單次送出的英雄數量
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          "1000000038262", "1000000047704", "1000000073976"
        ],
        "minStamina": 15, // 執行任務的最低體力值
        ...
        "pairAddressMappings": [
          {
            ...
            "singleBatchAmount": 2, // 單次送出的英雄數量
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              "1000000043531", "1000000063769", "294416", "1000000085708"
            ],
          },                 {
        ...
        "quests": [
          {
            "name": "StatQuest_Str", // 有地方會用到這個值，不要更改它
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              "2000000000175", "1000000090424", "1000000029603", "1000000074412", "1000000082547",
              "1000000017472", "1000000041503", "1000000041547", "1000000026736", "1000000085774",
              "1000000013079", "1000000021351", "248925", "1000000081281",
          ...
          },
          {
            "name": "StatQuest_Dex", // 有地方會用到這個值，不要更改它
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              "1000000092583", "1000000092139",  "1000000019469", "1000000012231", "1000000021885", "1000000018216", "1000000041938",
    ...
    "heroForSale": [ // 你想要販售的英雄與價格，price 請填整數，否則會出錯
      // 格式範例 { "id": "1234", "price": 25000 }
      { "id": "2000000000175", "price": 15999 },
      { "id": "2000000000171", "price": 7499 },
      { "id": "203884", "price": 75 },
      ...
      { "id": "273563", "price": 59 },
      { "id": "2000000000938", "price": 89 },
      { "id": "1000000088518", "price": 35 },
      { "id": "1000000082547", "price": 75 },
      { "id": "1000000086884", "price": 29 },
      { "id": "1000000090711", "price": 29 },
      { "id": "1000000026736", "price": 37 },
      { "id": "1000000047075", "price": 55 },
      { "id": "1000000074412", "price": 45 },
      { "id": "1000000059688", "price": 39 },
      { "id": "1000000064305", "price": 35 },
      { "id": "1000000091343", "price": 49 },
      { "id": "1000000091078", "price": 149 },
      { "id": "1000000091096", "price": 49 },
      { "id": "1000000091835", "price": 25 },
      { "id": "1000000092139", "price": 25 },
      { "id": "1000000081281", "price": 49 },
      { "id": "303103", "price": 65 },
      { "id": "221872", "price": 59 },
      { "id": "253125", "price": 35 },
      { "id": "263373", "price": 45 },
      { "id": "1000000010037", "price": 45 },
      { "id": "254994", "price": 49 },
    ],
    "useRpcIndex": 0, // 表示你想要使用的 rpc ，0 是 下方 rpcs 的第一個，1 是第二個以次類推，網路卡頓的時候可以嘗試換個 rpc
    "rpcs": [
    ...
    "overBaseGasFeeWei": 550000000, // 表示你願意出高於 baseFee 多少的 gas，理論上這個數字越高你的交易速度就會越快， 110000000 表示 0.11 Gwei，請依你的需要調整
    "listStamina": 24, // 表示當你的英雄體力低於多少時要進行掛售，體力值高於這個設定的英雄如果是下架狀態會等做完任務才會再次上架
    "newworkRentalEstimateAdjustment": 0.7 // KLAY 鏈的出租估價完會在乘以這個數，如果覺得 KLAY 鏈估價太低或太高可以調整這個數字
  },
