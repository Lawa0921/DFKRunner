...
const config = {
  ...
  "defikingdoms": {
    "quest": {
      "fishing": {
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          ...
          "1000000031003","1000000091834", "64707", "2000000011645",
          "1000000001412", "1000000031708", "2000000006086", "2000000011650",
          "1000000002619", "1000000006002", "1000000091077",
          "1000000011636", "1000000091087", "1000000091200", "1000000131349",
          "265263", "295105", "1000000032565", "2000000008084", "1000000131263",
          "240170", "284245", "2000000027099", "2000000030266",
          ...
          "256447", "158263", "275612", "277968", "1000000136809",
          ...
          "1000000074719", "1000000051186", "302516", "1000000138241",
          "1000000015292", "270822", "306134", "2000000011592",
      ...
      "foraging": {
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          "2000000027884", "1000000138084", "1000000138240", "1000000138256"
        ],
        "minStamina": 25, // 執行任務的最低體力值
        ...
        "pairAddressMappings": [
          {
            ...
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              "1000000116359", "185417", "1000000091826", "205585", "1000000093057", "231246"
            ],
          },                 {
    ...
    "heroForSale": [ // 你想要販售的英雄與價格，price 請填整數，否則會出錯
      ...
      { "id": "1000000015292", "price": 149 },
      { "id": "1000000032565", "price": 125 },
  ...
  "klay": {
    ...
    "heroForSale": [ // 你想要販售的英雄與價格，price 請填整數，否則會出錯
      ...
      { "id": "1000000062345", "price": 69 },
      { "id": "2000000010872", "price": 59 },
      { "id": "274245", "price": 95 },
      { "id": "170607", "price": 219 },
      { "id": "245326", "price": 175 },
      { "id": "1000000110042", "price": 249 },
      { "id": "1000000021351", "price": 149 },
      { "id": "1000000055666", "price": 129 },
      { "id": "1000000080914", "price": 65 },
      { "id": "1000000025803", "price": 125 },
      { "id": "1000000041812", "price": 75 },
      { "id": "1000000064162", "price": 129 },
      { "id": "1000000073224", "price": 85 },
      { "id": "1000000026278", "price": 85 },
      { "id": "285602", "price": 259 },
      { "id": "1000000015216", "price": 129 },
      { "id": "1000000088328", "price": 165 },
      { "id": "257297", "price": 85 },
      { "id": "1000000082034", "price": 75 },
      { "id": "1000000004431", "price": 129 },
      { "id": "2000000009743", "price": 69 },
      { "id": "2000000027093", "price": 65 },
      { "id": "1000000014478", "price": 155 },
      { "id": "2000000015254", "price": 85 },
      { "id": "1000000088622", "price": 175 },
      { "id": "2000000018663", "price": 55 }
    ],
    "useRpcIndex": 0, // 表示你想要使用的 rpc ，0 是 下方 rpcs 的第一個，1 是第二個以次類推，網路卡頓的時候可以嘗試換個 rpc
    "rpcs": [
  ...
  "autoBuyerSetting": {
    ...
    "KLAYnetworkBuyerEstimateAdjustment": 0.75, // KLAY 鏈的購買估價會再乘以這個數，如果覺得 KLAY 鏈估價太低或太高可以調整這個數字
  ...
  "autoRenterSetting": {
    ...
    "DFKNetworkRentalEstimateAdjustment": 1.5, // DFK 鏈的出租估價完會在乘以這個數，如果覺得 DFK 鏈估價太低或太高可以調整這個數字
