...
const config = {
  ...
  "klay": {
    ...
    "heroForSale": [ // 你想要販售的英雄與價格，price 請填整數，否則會出錯
      ...
      { "id": "245326", "price": 235 }, 
      { "id": "1000000055666", "price": 185 }, 
      { "id": "1000000088622", "price": 235 }, 
      { "id": "1000000066888", "price": 175 }, 
    ],
    "useRpcIndex": 0, // 表示你想要使用的 rpc ，0 是 下方 rpcs 的第一個，1 是第二個以次類推，網路卡頓的時候可以嘗試換個 rpc
    "rpcs": [
