...
const config = {
  ...
  "defikingdoms": {
    "quest": {
      "fishing": {
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          ...
          "278240"       , "185707"       , "1000000042559", "2000000013986",
          "256447"       , "158263"       , "275612"       , "277968"       , "1000000036881", "1000000138818",
          ...
          "287580"       , "291845"       , "1000000070345", "1000000135398",
          "2000000004564", "1000000109254", "2000000019464", "1000000138242",
          "294810"       , "1000000087664", "1000000129706", "2000000030186",
          "301253"       , "185795"       , "1000000091082", "1000000118325",
          "1000000074719", "1000000051186", "302516"       , "2000000030693",
          "270822"       , "306134"       , "2000000011592", "2000000023906",
          "272686"       , "301639"       , "305852"       , "305635"       , "1000000022759",
          "1000000016637", "1000000091824", "1000000051985", "2000000022290",
          "1000000023115", "1000000091103", "278830"       , "2000000025536",
        ...
        "pairAddressMappings": [
          {
            ...
            "singleBatchAmount": 2, // 單次送出的英雄數量
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              "1000000003941", "1000000009289", "1000000063769", "1000000011052", "1000000014451", "1000000134965"
            ],
          },                 {
        ...
        "quests": [
          {
            ...
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              ...
              "2000000024151", "2000000026348", "1000000121968"
            ],
          ...
          },
          {
            ...
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              "1000000027626", "1000000030876", "1000000037933", "1000000038061",
          ...
          },
          {
            ...
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              "1000000026987", "1000000028544", "1000000059047", "2000000018790", "1000000032435",
              "1000000079362", "2000000015307", "2000000028749", "1000000133005", "35045"
            ],
          ...
          },
          {
            ...
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              ...
              "1000000015687", "1000000136226", "1000000137771"
            ],
    ...
    "heroForSale": [ // 你想要販售的英雄與價格，price 請填整數，否則會出錯
      ...
      { "id": "291333", "price": 175 },
      { "id": "1000000003941", "price": 155 },
      { "id": "249058", "price": 319 },
      { "id": "1000000012231", "price": 319 },
      { "id": "1000000091334", "price": 199 },
      { "id": "1000000121968", "price": 249 },
      { "id": "1000000028544", "price": 229 },
      { "id": "208697", "price": 169 },
    ...
    "quest": {
      ...
      "foraging": {
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          ...
          "88372"        , "1000000130765", "47809"        , "2000000031113",
      ...
      "jadeMining": {
        ...
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          ...
          "1000000025803", "248208"       , "2000000000175", "1000000043706", "1000000055666",
