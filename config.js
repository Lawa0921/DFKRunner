...
const config = {
  ...
  "defikingdoms": {
    "quest": {
      "fishing": {
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          ...
          "1000000091087", "1000000091200", "1000000131349", "1000000145389",
          ...
          "1000000091824", "1000000051985", "2000000022290", "222280"       ,
          ...
          "1000000027815", "1000000044846", "2000000016561", "1000000133377", "2000000029334",
      ...
      "foraging": {
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          ...
          "259900"       , "1000000138351", "1000000002969", "1000000147801",
        ...
        "quests": [
          ...
          },
          {
            ...
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              ...
              "1000000073168", "1000000088471", "1000000029546", "2000000033061",
    ...
    "duelSetting": {
      ...
      "type": "war", // duel 的類型，solo, squad, war 其中一種
    ...
    "quest": {
      ...
      "jadeMining": {
        ...
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          ...
          "1000000001443", "1000000088622", "1000000051941", "1000000029603", "2000000013225", "2000000031812",
        ],
        "minStamina": 15, // 執行任務的最低體力值
