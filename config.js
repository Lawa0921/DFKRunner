...
const config = {
    ...
    "quest": {
      "fishing": {
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          ...
          "245862", "1000000042496", "1000000091342", "1000000131387",
          "266063", "272671", "1000000130843", "1000000128529",
          "278240", "185707", "1000000042559", "2000000013986",
          "256447", "158263", "275612", "277968", "1000000082209",
          "262570", "279365", "280215", "1000000042854",
          ...
          "1000000074719", "1000000051186", "302516",
          "1000000015292", "1000000015916", "270822", "306134", "2000000011592",
          ...
          "197215", "1000000024102", "1000000135155",
          ...
          "1000000055672", "299980", "2000000011428", "2000000024155",
      ...
      "goldMining": {
        ...
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          ...
          "1000000037174", "1000000052561", "1000000091832", "1000000046668", "1000000091831", "2000000030287",
        ...
        "pairAddressMappings": [
          {
            ...
            "singleBatchAmount": 2, // 單次送出的英雄數量
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              "210943", "1000000127319", "249058", "208971"
            ],
          },                 {
            ...
            "singleBatchAmount": 2, // 單次送出的英雄數量
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              "1000000052377", "1000000086968", "1000000048648", "1000000043531", "1000000016290"
            ],
          },                 {
            ...
            "singleBatchAmount": 2, // 單次送出的英雄數量
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              "277280", "280166", "288259", "289658", "290196"
            ],
          },                 {
            ...
            "singleBatchAmount": 2, // 單次送出的英雄數量
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              "1000000127020", "2000000020688", "1000000085490", "2000000027484",
            ],
          },                 {
            ...
            "singleBatchAmount": 2, // 單次送出的英雄數量
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              "1000000003004", "252748", "171666", "2000000007607", "2000000027098", "1000000123064"
            ],
          },                 {
        ...
        "quests": [
          ...
          },
          {
            ...
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              ...
              "1000000079362", "2000000015307", "2000000028749"
            ],
  ...
  "klay": {
    "quest": {
      ...
      "foraging": {
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          ...
          "302481", "1000000069438", "1000000080914", "2000000002672",
          "1000000091332", "1000000094914", "1000000103880", "2000000010501",
          "268896", "300295", "304598", "1000000081279", "298992", "2000000009743",
          "238302", "240867", "1000000082262", "2000000009684", "1000000111721", "2000000025371",
          ...
          "1000000015216", "9371", "1000000073518", "1000000131490",
          ...
          "294495", "1000000083984", "1000000088328", "1000000130504",
          "103823", "305839", "1000000064538", "1000000090795", "1000000110042",
          "228546", "1000000041812", "141028", "1000000106927", "2000000030717",
          "1000000022615", "1000000022719", "1000000022203", "1000000026278",
    ...
    "heroForSale": [ // 你想要販售的英雄與價格，price 請填整數，否則會出錯
      ...
      { "id": "170607", "price": 219 },
      { "id": "245326", "price": 175 },
      { "id": "1000000022719", "price": 85 },
      { "id": "1000000111721", "price": 49 },
      ...
      { "id": "1000000014478", "price": 129 },
      { "id": "1000000083984", "price": 75 },
      { "id": "285602", "price": 259 },
  ...
  "autoBuyerSetting": {
    ...
    "KLAYnetworkBuyerEstimateAdjustment": 0.65, // KLAY 鏈的購買估價會再乘以這個數，如果覺得 KLAY 鏈估價太低或太高可以調整這個數字
