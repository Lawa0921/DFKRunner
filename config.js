...
const config = {
  ...
  "defikingdoms": {
    "quest": {
        ...
        "foraging": {
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                ...
                "273563", "238302", "240867", "1000000018502", "1000000082262",
                ...
                "302582", "1000000019784", "294495", "1000000083984",
        ...
        "goldMining": {
            ...
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                "275599", "233167", "235300", "1000000021036", "1000000029882", "295922",
        ...
        "statQuests": [
            ...
            },
            {
                ...
                "heroes": [ // 這裡面只會寫你自己擁有的 hero id
					...
					"1000000072029", "1000000074522", "1000000075777", "1000000088397"
                ],
    ...
    "notForRentHeroIds": [
      ...
      "1000000086890", "1000000084960", "1000000088518", "1000000088522", "1000000086648", "1000000087823" // 把你不想出租的英雄 ID 寫在這裡，例如： "1565", "1234" 
    ],
