...
const config = {
  ...
  "klay": {
    "quest": {
      "fishing": {
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          ...
          "1000000031003", "1000000087829","1000000091834", "64707",
          "1000000001412", "1000000031708", "2000000006086",
          ...
          "1000000016637", "253125", "1000000091824", "1000000051985",
      ...
      "foraging": {
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          ...
          "273563", "238302", "240867", "1000000082262", "2000000009684", "1000000111721",
          "273379", "295054", "1000000010814", "1000000015214", "1000000058189",
          "274898", "281743", "270856", "1000000066747", "2000000003713",
          "196393", "239243", "273072", "1000000095474", "2000000010872",
          "246258", "225740", "273663", "274245", "1000000009838", "1000000114075",
          "273818", "277774", "182721", "114122", "1000000043522",
          "246344", "283480", "141989", "1000000036454", "1000000111575",
        ...
        "quests": [
          {
            "name": "StatQuest_Str", // 有地方會用到這個值，不要更改它
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              "1000000041503", "1000000041547", "1000000085774", "1000000112930",
              "248925",
          ...
          },
          {
            ...
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              ...
              "1000000079362", "185295", "300815", "1000000114140"
            ],
    ...
    "heroForSale": [ // 你想要販售的英雄與價格，price 請填整數，否則會出錯
      ...
      { "id": "298690", "price": 85 },
      { "id": "1000000025200", "price": 85 },
      { "id": "1000000051353", "price": 249 },
      { "id": "1000000019784", "price": 75 },
      { "id": "1000000086639", "price": 85 },
      { "id": "1000000104556", "price": 85 },
      { "id": "1000000061159", "price": 75 },
      { "id": "1000000032565", "price": 79 },
      { "id": "1000000017472", "price": 129 },
      { "id": "1000000091083", "price": 49 },
      { "id": "1000000021885", "price": 79 },
      { "id": "1000000026281", "price": 65 },
      { "id": "1000000020648", "price": 65 },
      { "id": "1000000048607", "price": 89 },
      { "id": "1000000055999", "price": 55 }
    ],
    "useRpcIndex": 0, // 表示你想要使用的 rpc ，0 是 下方 rpcs 的第一個，1 是第二個以次類推，網路卡頓的時候可以嘗試換個 rpc
    "rpcs": [
