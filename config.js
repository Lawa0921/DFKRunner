...
const config = {
  ...
  "defikingdoms": {
    "quest": {
        "fishing": {
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                ...
                "292069", "294810", "1000000043741",
                "301253", "185795", "1000000074849",
                "1000000076100", "1000000074719",
        ...
        "foraging": {
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                "300803", "1000000031167", "1000000073224", "221884",
                ...
                "218128", "287938", "1000000020401", "1000000043525", "1000000081555",
                ...
                "1000000004431", "1000000049843", "1000000083536",
        ...
        "goldMining": {
            ...
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                ...
                "272569", "96964", "243889", "305904", "1716", "1000000052725"
            ],
        ...
        "statQuests": [
            {
                ...
                "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                     ...
                     "1000000017472", "1000000041503", "1000000041547", "1000000026736",
                     ...
                     "1000000047075", "1000000048607", "162779", "1000000084960",
                     "1000000051353", "1000000052246", "1000000024773",
            ...
            },
            {
                ...
                "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                    ...
                    "1000000053380", "1000000055666", "1000000072758", "1000000039706"
                ],
            ...
            },
            {
                ...
                "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                    "1000000022549", "1000000027870", "1000000030734",
    ...
    "notForLevelUpHeroIds": [
        "1716", "1000000030460"// 把你不想自動升級的英雄 ID 寫在這裡，例如： "1716", "123456"
    ],
    ...
    "duelSetting": [ // 注意: 同一時間只能有一個進行中的 duel，這表示你只能將一種類型開啟為 true
          ...
          ["1000000064538", "1000000051353", "1000000073976"]
			...
			},
			{
				...
				"isActive": false, // 表示是否要執行該 type 的 duel，true 的情形就會自動執行
				"heroes": [
          ["1000000051294", "1000000051386", "295922", "51278", "1000000043525", "294810", "1000000065836", "1000000051941", "1000000042867"],
  ...
  "unconditionalPurchasePrice": 26, // 當上架的英雄價格低於這個值時會直接購買，不會進入估價邏輯
