...
const config = {
  ...
  "defikingdoms": {
    "quest": {
      "fishing": {
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          ...
          "266063"       , "272671"       , "1000000130843", "1000000128529", "1000000138255",
          ...
          "1000000016637", "1000000091824", "1000000051985", "2000000022290", "222280"       ,
          ...
          "1000000049957", "1000000091425", "1000000151423",
      ...
      "foraging": {
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          ...
          "259900"       , "1000000138351", "1000000145753", "1000000002969", "1000000149169", "1000000147801",
          "1000000151519", 
        ],
        "minStamina": 25, // 執行任務的最低體力值
      ...
      "goldMining": {
        ...
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          ...
          "1000000058211", "1000000074522", "1000000091334", "1000000012231", "1000000072500", "1000000093700"
        ],
        "minStamina": 25, // 執行任務的最低體力值
        ...
        "pairAddressMappings": [
          {
            ...
            "singleBatchAmount": 2, // 單次送出的英雄數量
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              "295657", "296812", "299493", "303812", "304918"
            ],
          }
        ],
        "minStamina": 15, // 執行任務的最低體力值
        ...
        "quests": [
          {
            ...
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              ...
              "1000000052246", "1000000087935", "1000000087038", "1000000000528", "1000000142255",
          ...
          },
          {
            ...
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              ...
              "1000000073168", "1000000088471", "1000000029546", "2000000009843",
          ...
          },
          {
            ...
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              "1000000038381", "1000000102496", "1000000112309", "2000000017896", "2000000031812",
              "260621"       ,
            ],
    ...
    "heroForSale": [ // 你想要販售的英雄與價格，price 請填整數，否則會出錯
      ...
      { "id": "1000000058211", "price": 229 },
      { "id": "1000000074522", "price": 199 },
      ...
      { "id": "1000000145753", "price": 599 },
      { "id": "1000000016637", "price": 159 },
    ...
    "quest": {
      ...
      "jadeMining": {
        ...
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          ...
          "1000000001443", "1000000088622", "1000000051941", "1000000029603", "1000000059559", "2000000013225",
        ],
        "minStamina": 15, // 執行任務的最低體力值
