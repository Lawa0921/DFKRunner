...
const config = {
  ...
  "defikingdoms": {
    "quest": {
        "fishing": {
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                ...
                "1000000051289", "1000000051294", "1000000051362", "1000000051374", "1000000051186"
            ],
        ...
        "statQuests": [
            {
                ...
                "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                     ...
                     "1000000051275", "1000000051353", "1000000052246", "1000000024773"
                ],
            ...
            },
            {
                ...
                "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                    ...
                    "1000000049030", "1000000051702", "1000000052245", "1000000053034"
                ],
            ...
            },
            {
                ...
                "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                    ...
                    "51278", "293129", "1000000052561", "1000000053360"
                ],
            ...
            },
            {
                ...
                "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                    ...
                    "296669", "1000000007008", "1000000047897",
                    "1000000002241",
                ],
    ...
    "heroForSale": [ // 你想要販售的英雄與價格，price 請填整數，否則會出錯
        ...
        { "id": "1000000007008", "price": 75 },
        { "id": "254693", "price": 55 },
        { "id": "1000000015231", "price": 55 },
        { "id": "305150", "price": 55 },
        { "id": "244783", "price": 79 },
        { "id": "283813", "price": 55 },
        { "id": "287436", "price": 55 },
