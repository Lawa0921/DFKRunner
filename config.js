...
const config = {
  ...
  "defikingdoms": {
        ...
        "statQuests": [
            ...
            },
            {
                ...
                "heroes": [ // 這裡面只會寫你自己擁有的 hero id
					...
					"1000000073168", "1000000081466", "1000000086639"
                ],
            ...
            },
            {
                ...
                "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                    "1000000042880", "1000000058161", "1000000058211", "1000000059559",
    ...
    "notForRentHeroIds": [
        "1000000083930", "1000000086705", "1000000085586", "1000000081466" // 把你不想出租的英雄 ID 寫在這裡，例如： "1565", "1234" 
    ],
