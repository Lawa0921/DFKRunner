...
const config = {
    ...
    "quest": {
      "fishing": {
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          ...
          "272487"       , "1000000068962", "1000000071650", "1000000140909",
          ...
          "1000000051294", "1000000054937", "1000000091920", "1000000150930", "1000000159952",
      ...
      "foraging": {
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          ...
          "274898"       , "270856"       , "1000000066747", "2000000003713",
          "196393"       , "2000000010872", "2000000018179", "2000000034356",
          ...
          "264342"       , "290898"       , "54615"        , "2000000026040",
          ...
          "1000000027440", "292136"       , "292255"       , "1000000051738",
          "1000000051357", "1000000068137", "1000000091353", "2000000024165", "2000000024106",
          "1000000060323", "1000000052155", "1000000062345", "1000000065836", "2000000024104",
        ],
        "minStamina": 25, // 執行任務的最低體力值
        ...
        "quests": [
          {
            ...
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              ...
              "1000000038180", "1000000082849", "1000000156245", "1000000154673", "2000000037335",
          ...
          },
          {
            ...
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              ...
              "2000000016386", "2000000018230", "1000000162651", "1000000167505"
            ],
          ...
          },
          {
            ...
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              "1000000027626", "1000000030876", "1000000038061", "214463"       ,
          ...
          },
          {
            ...
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              ...
              "1000000091089", "1000000149027", "1000000158815",
          ...
          },
          {
            ...
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              ...
              "1000000136226", "1000000137771", "273458"       , "1000000154076",
            ],
  ...
  "autoBuyerSetting": {
    ...
    "KLAYnetworkBuyerEstimateAdjustment": 1, // KLAY 鏈的購買估價會再乘以這個數，如果覺得 KLAY 鏈估價太低或太高可以調整這個數字
    "DFKnetworkBuyerEstimateAdjustment": 0.8, // DFK 鏈的購買估價會再乘以這個數，如果覺得 DFK 鏈估價太低或太高可以調整這個數字
