...
const config = {
    ...
    "quest": {
        ...
        "foraging": {
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                ...
                "264398", "268896", "278579", "300295", "304598", "1000000072080",
            ...
            "pairAddressMappings": [
                {
                    ...
                    "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                        "1000000009694", "306400", "1000000025572", "131880", "1000000053360"
                    ],
                },                 {
    ...
    "duelSetting": [ // 注意: 同隻英雄無法同時放入多個不同 type
			{
				...
				"heroes": [], // 在這邊寫你想要嘗試送去 duel 的英雄 id solo 範例: [["1234"], ["5678"], ["91011"]]
			},
			{
				"type": "squad", // duel 的類型，你不會更改這個值
				"fee": "low", // 花費幣的數量 low = 0.3 medium = 1.5 large = 3
				"isActive": true, // 表示是否要執行該 type 的 duel，true 的情形就會自動執行
				"heroes": [["1000000030460", "1000000064538", "1000000050447"], ["1716", "1000000022759", "294416"], ["1000000029707", "1000000038381", "1000000042202"]], // 在這邊寫你想要嘗試送去 duel 的英雄 id squad 範例: [["1234", "5678", "91011"], ["121314", "151617", "181920"]]
			},
			{
  ...
  "setDuelScriptTimeSecond": 180, // 設定你每次執行 duel 腳本的間隔秒數
