...
const config = {
    ...
    "quest": {
      "fishing": {
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          ...
          "262570"       , "279365"       , "280215"       , "1000000042854", "2000000012839",
          "275690"       , "272487"       , "1000000068962", "1000000071650", "1000000140909",
          ...
          "2000000011428", "2000000024155", "1000000140072", "1000000131964", "216963"       ,
          ...
          "1000000140288", "1000000163057", "1000000167168"
        ],
      ...
      "goldMining": {
        ...
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          "1000000089287", "1000000091078", "303804"       , "208697"       , "1000000080531", "2000000013000",
        ...
        "quests": [
          {
            ...
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              ...
              "1000000038180", "1000000082849", "1000000156245", "1000000154673", "2000000035944",
              "1000000144091", "1000000158142", "2000000033642", "2000000022224"
            ],
  ...
  "autoBuyerSetting": {
    ...
    "DFKnetworkBuyerEstimateAdjustment": 0.95, // DFK 鏈的購買估價會再乘以這個數，如果覺得 DFK 鏈估價太低或太高可以調整這個數字
