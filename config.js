    ...
    "quest": {
      "fishing": {
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          ...
          "2000000121034", "1000000268250", "2000000193316", "2000000192114", "2000000288970",
          "1000000256449", "1000000323526", "2000000220949", "2000000177171", "1000000056212",
      ...
      "foraging": {
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          ...
          "1000000169754", "1000000420244", "1000000419415", "2000000292624", "1000000410773",
          "103823"       , "1000000064538", "1000000192365", "1000000417513", "1000000419694",
          "292136"       , "2000000292428", "1000000416268",
      ...
      "goldMining": {
        ...
        "heroes": [ // 這裡面只會寫你自己擁有的 hero id
          ...
          "1000000022549", "1000000254330", "2000000161338", "1000000138253", "1000000323764",
          "1000000072500", "2000000063830", "180095"       , "1000000254941", "1000000346672", "2000000064543"
        ],
        ...
        "pairAddressMappings": [
          {
            ...
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              "2000000177339", "2000000183901", "2000000184094", "1000000339355"
            ],
          },                 {
            ...
            "singleBatchAmount": 2, // 單次送出的英雄數量
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              "1000000009289", "2000000032177", "2000000161598", "1000000263698", "2000000162296"
            ],
          },                 {
            ...
            "singleBatchAmount": 2, // 單次送出的英雄數量
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              "2000000134616", "1000000218267", "2000000107313", "2000000214722", "1000000325566"
            ],
          },                 {
        ...
        "quests": [
          {
            ...
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              "1000000085774", "2000000006116", "1000000325551",
              ...
              "256082"       , "1000000269835", "1000000284064", "2000000194572",
              "1000000038180", "2000000044937", "1000000253341", "2000000148772", "1000000346700",
              "2000000033642", "2000000022224", "1000000357355",
          ...
          },
          {
            ...
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              ...
              "2000000006821", "1000000109415", "2000000005262",
          ...
          },
          {
            ...
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              ...
              "2000000037802", "2000000137064", "1000000325568", "2000000218383",
              "2000000073705",
              "2000000086742",
          ...
          },
          {
            ...
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              "2000000084150", "2000000170320", "1000000277715", "1000000401172",
              "2000000044503", "1000000222082",
          ...
          },
          {
            ...
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              "2000000131553", "1000000263439", "1000000306045",
          ...
          },
          {
            ...
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
              "2000000099589", "2000000163947", "1000000327054",
              "2000000215309",
