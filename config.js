    ...
    "quest": {
        "fishing": {
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                ...
                "258640", "1000000023115", "1000000047447",
        ...
        "foraging": {
            "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                ...
                "1000000019784", "294495", "1000000083984",
        ...
        "statQuests": [
            ...
            },
            {
                ...
                "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                    ...
                    "51278", "293129", "1000000052561", "285602", "1000000072014", "1000000086648",
                    "306304"
                ],
            ...
            },
            {
              ...
              "heroes": [ // 這裡面只會寫你自己擁有的 hero id
                "1000000022549", "1000000027870", "1000000030734", "1000000087025",
