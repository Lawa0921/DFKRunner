...
exports.watchHeroLog = (hero, price) => {
    str = `id: ${hero.id}, ${hero.formatRarity()} LV${hero.level} ${hero.profession} G${hero.generation} ${hero.summons_remaining}/${hero.maxsummons} ${hero.formatMainclass()}/${hero.formatSubclass()}, ${hero.statboost1} ${hero.statboost2} listed ${parseInt(price) / Math.pow(10, 18)} J`
    console.log(str);
