...
module.exports = class Hero {
  ...
  selfStatMatch(stat) {
    const state = hero[stat];

    if (state === undefined) {
      console.log("stat input mistake");
      return false;
    }

    switch(this.formatMainclass()) {
      case "Warrior":
        return state === "STR" || state === "VIT" ? true : false;
      case "Knight":
        return state === "STR" || state === "VIT" ? true : false;
      case "Thief":
        return state === "AGI" || state === "LCK" ? true : false;
      case "Archer":
        return state === "DEX" ? true : false;
      case "Priest":
        return state === "INT" || state === "WIS" ? true : false;
      case "Wizard":
        return state === "INT" || state === "WIS" ? true : false;
      case "Monk":
        return false;
      case "Pirate":
        return state === "STR" || state === "DEX" ? true : false;
      case "Berserker":
        return state === "STR" ? true : false;
      case "Seer":
        return state === "INT" || state === "WIS" ? true : false;
      case "Paladin":
        return state === "STR" || state == "VIT" || state == "END" ? true : false;
      case "DarkKnight":
        return state === "STR" ? true : false;
      case "Summoner":
        return state === "INT" || state === "WIS" ? true : false;
      case "Ninja":
        return state === "AGI" || state === "DEX" || state === "LCK" ? true : false;
      case "Shapeshifter":
        return state === "DEX" || state === "AGI" ? true : false;
      case "Dragoon":
        return state === "STR" || state === "DEX" ? true : false;
      case "Sage":
        return state === "INT" || state === "WIS" ? true : false;
  ...
  selfStatProfessionMatch(stat) {
    ...
    switch(this.profession) {
      case "mining":
        return state === "STR" || state === "END" ? true : false;
      case "gardening":
        return state === "VIT" || state === "WIS" ? true : false;
      case "foraging":
        return state === "DEX" || state === "INT" ? true : false;
      case "fishing":
        return state === "AGI" || state === "LCK" ? true : false;
    }
  }
